...
const loginUser = asyncHandler(async (req, res) => {
  ...
  // check if the user if already exists or not
...
// create a controller to logout the user
...
const logoutUser = asyncHandler(async (req, res) => {
  await User.findByIdAndUpdate(
    ...
    {
      $unset: {
        refreshToken: 1,            // this removes the refresh token field from the document
      },
    },
    {
      new: true,
...
const updateAccountDetails = asyncHandler(async (re, res) => {
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  // todo:delete old image -asssignment
  const coverImage = await uploadOnCloudinary(coverImageLocalPath);
